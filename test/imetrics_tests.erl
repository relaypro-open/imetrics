...
start_get() ->
    ...
    imetrics:add(tagged_counter, #{tag2 => "val1"}),
    imetrics:set_gauge(gauge2, 0.6),
    imetrics:set_exemplar(counter2, 3, #{testLabel => testLabelValue}, 1262304000),
    imetrics:set_exemplar(tagged_counter, #{tag2 => "val1"}, 1.23, 946684800),
    imetrics:set_exemplar(tagged_counter, 100, 946684800),
...
http_test_openmetrics(#{port := Port}) ->
    ...
    Res = [
        ...
        "tagged_counter{tag2=\"val1\"} 1 # {} 1.23 946684800",
        "# TYPE fn_gauge gauge",
        "fn_gauge{} 1.5",
        "# TYPE gauge gauge",
        "gauge{} 1.5",
